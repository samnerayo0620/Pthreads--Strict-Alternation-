// Samuel Nerayo
// assignment 2-2: Working with Pthreads - Strict Alternation
#include <iostream>
#include <pthread.h>
...
int main()
{
    ...
    // Added pthread_join which waits for all the threads to complete and then exists
    pthread_join(the_thread, NULL);

    if(rc){ //empty if statment that tell the compiler that rc is used
    }
